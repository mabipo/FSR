function [clutterPowerMatrix,y_gridPoints,x_gridPoints,kk,qq,maxCPM,Doppler_signature]=Clutter_pisa(hTx,freq,BL)
...
%     %
    ...
    Doppler_signature1=TRP_def(rx,tx,fan_pos,freq,FSCS,epsR,sigma_ground,t(end),sRate) ;%TRP
